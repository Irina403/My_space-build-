...
$('.contactForm__control').click(function(){
    console.log('click');
    if ($('.contactForm__form-control').is(':checked')){
		$('.contactForm__form-control input:checkbox').prop('checked', true);
	} else {
		$('.contactForm__form-control input:checkbox').prop('checked', false);
	}
});

$('.button-send').click(function(){
    console.log('click');
    $('.good_message').addClass('active');
});
